...
from flask import Flask, render_template, send_file, redirect, request, send_from_directory, url_for, abort,make_response
...
def parse_arguments():
    parser = argparse.ArgumentParser(prog='digiup')
    cwd = os.getcwd()
...
def main():
    ...
    def download():
        ...
        # Validate and sanitize the 'path' parameter to avoid security risks.
        # Ensure that 'path' is within an allowed directory, e.g., your base directory.
        ...
        # Create a ZIP file with the contents of the specified directory
        try:
